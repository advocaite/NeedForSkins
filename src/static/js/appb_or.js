var io = io.connect('http://needforskins.com:3000');
var interval;
...
$(document).ready(function(){
	...
	io.on('roundupdate', function(data){
		...
		$('title').html('$'+myround(data.current_bank)+' NeedForSkins.com');
...
function antispam(nick) {
	...
	if(result && !result[1].match(/needforskins?\.com/i)){
		//return "***";
